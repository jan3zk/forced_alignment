...
* [add_speaker-ID_tier.py](additional_tiers/add_speaker-ID_tier.py): The script parses speaker intervals from an XML file and adds them as a new 'speaker-ID' tier to an existing TextGrid file, which is then saved to a specified output TextGrid file.
